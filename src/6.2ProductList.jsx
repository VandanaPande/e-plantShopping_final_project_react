//Removed fewimages and other details for question 1
...
function ProductList({ onHomeClick }) {
  ...
  const [showPlants, setShowPlants] = useState(false); // About/Plants toggle
  const [addedToCart, setAddedToCart] = useState({});

  const dispatch = useDispatch();

  // Read cart items from Redux & compute total quantity (Task 4)
  ...
  const plantsArray = [
    {
      ...
      plants: [
        ...
        { name: "Rubber Plant", image: "https://cdn.pixabay.com/photo/2020/02/15/11/49/flower-4850729_1280.jpg" },
        { name: "Aloe Vera" }
      ]
    },
    {
      ...
      plants: [
        ...
        { name: "Hyacinth", image: "https://cdn.pixabay.com/photo/2019/04/07/20/20/hyacinth-4110726_1280.jpg" }
      ]
    },
    {
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Calendula", image: "https://cdn.pixabay.com/photo/2019/07/15/18/28/flowers-4340127_1280.jpg", }
      ]
    },
    {
    ...
    <div>
      <div className="navbar" style={styleObj}>
        ...
        <div style={styleObjUl}>
          ...
          {/* Cart icon with live total badge from Redux */}
