...
function ProductList({ onHomeClick }) {
    ...
    // Static total number of items for partial point 1 (should always show 0)
    const calculateTotalItems = () => {
        return cart.length === 0 ? 0 : cart.reduce((total, item) => total + item.quantity, 0); // Will return 0 for empty cart
    };
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                {calculateTotalItems()} {/* Will show 0 until cart has items */}
                            </h1>
                        </a>
                    </div>
                </div>
